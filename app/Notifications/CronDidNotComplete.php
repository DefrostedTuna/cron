...
class CronDidNotComplete extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->markdown('mail.markdown.cron-did-not-complete', ['monitor' => $this->monitor,  'url' => url('/')]); // TODO: Set the proper references for this
    }
    ...
    public function toSlack($notifiable)
    {
        return (new SlackMessage)
            ...
            ->attachment(function ($attachment) {
                ...
                ->fields([
                    'Status' => 'Did not complete', // TODO: Make status method
